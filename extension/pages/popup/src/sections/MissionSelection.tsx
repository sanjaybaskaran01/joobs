...
export const MissionListSection = (): JSX.Element => {
  ...
  return (
    <section className="flex flex-col items-start gap-6 p-6 relative self-stretch w-full">
      ...
      <div className="flex flex-col items-start gap-2 relative self-stretch w-full flex-[0_0_auto]">
        {friendsData.map((friend) => (
          ...
          >
            <CardContent className="flex w-full max-w-[497px] items-center gap-3 relative flex-[0_0_auto] p-0">
              <img
